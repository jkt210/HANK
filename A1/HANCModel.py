...
class HANCModelClass(EconModelClass,GEModelClass):    
    ...
    def setup(self):
        ...
        par.Nfix = 6 # number of fixed discrete states (here discount factor)
        par.Nbeta = 3 # Number of distinct betas
        par.Neta = 2 # Number of distinct etas
        ...
        par.w0_ss_target = 1.0 # target for real wage
        par.w1_ss_target = 1.0 # target for real wage
